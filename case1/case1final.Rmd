...
#plot residual vs predictor! (i.e. resids at all values of dose1)
fitvals <- exp(predict(m4, dat_train))
predictors <- 1/(dat_train$dose1+1/2)
predictors2 <- dat_train$dose2
plot(predictors, fitvals)
```

...
##### Analysis
```{r}
#These plots need to be cleaned up but here are the basics
...
compute_errs <- function(mod, test){
...
random_dose_errs <- compute_errs(m2, dat_test)
fixed_dose_errs <- compute_errs(m1.full, dat_test)

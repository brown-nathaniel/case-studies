...
The residual plots contains signs of slight arching in the Residual vs. Fitted Values. This suggests that a non-linear approach may be helpful, so we apply kernel regression.
